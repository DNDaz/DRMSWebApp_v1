    ...
    <v-layout row>
      ...
      <v-flex xs12>
        ...
        <v-layout row >
         ...
         <v-card row>
              <v-layout row wrap>
                <v-flex xs3><v-text-field :disabled="!enabled" label="Did you close off all running water ?"></v-text-field></v-flex>
                ...
                <!--v-flex xs2><v-checkbox v-model="enabled" hide-details class="shrink mr-2"></v-checkbox></v-flex-->
                <v-flex xs2><v-text-field :disabled="!enabled" label="Is water meter leaking" class="textColor" ></v-text-field></v-flex>
                  <v-flex xs1> 
                  <v-select
                ...
                <v-flex xs3><v-text-field label="Did you take an remedial action(s)"></v-text-field></v-flex>
                <v-flex xs2> 
                  <!--v-select
